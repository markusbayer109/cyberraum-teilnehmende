"""Arbeitsbasis für Slot 3: den minimalen ReAct-Agenten erweitern.

Der Kontrollfluss aus Slot 2 ist vollständig. In Slot 3 werden die vier
markierten TODOs für JSON-POST und den Werkzeugadapter bearbeitet. Danach wird
optional eine frei gewählte Verbesserung an Prompt, Zustand oder Schleife
umgesetzt.
"""
...
TODO 1: Ergänze hier das Format für http_post mit path und json_body.
...
def http_post(path: str, json_body: dict[str, Any]) -> str:
    ...
    # TODO 3: Sende einen POST request und gib die Antwort mit
    # response_observation zurück. Orientiere dich an http_get.
    raise NotImplementedError("http_post ist noch nicht implementiert.")
...
def execute_action(action: dict[str, Any]) -> str:
    ...
    # TODO 4: Leite http_post mit path und json_body an das neue Werkzeug weiter.
